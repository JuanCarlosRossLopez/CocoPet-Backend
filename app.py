...
from modules.api_chatgpt import api_chatgpt_bp
import os
...
app.register_blueprint(api_ventas_bp, url_prefix='/api')
...
def health():
    return jsonify({'status': 'ok', 'message': 'Servidor activo para VetChatbot'})
